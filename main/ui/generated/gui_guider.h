...
typedef struct
{
	...
	lv_obj_t *screen_MeasurePage_label_12;
	lv_obj_t *screen_MeasurePage_bar_state;
	lv_obj_t *screen_MeasurePage_label_13;
	lv_obj_t *screen_MeasurePage_label_14;
	...
	lv_obj_t *screen_SettingPage_tileview;
	lv_obj_t *screen_SettingPage_tileview_tile_Prep;
	lv_obj_t *screen_SettingPage_tileview_tile_Meas;
	lv_obj_t *screen_SettingPage_tileview_tile_Clean;
...
LV_IMG_DECLARE(_img_arrow_down_alpha_45x11);
LV_IMG_DECLARE(_img_arrow_up_alpha_45x11);
