...
void init_scr_del_flag(lv_ui *ui)
{
    ...
    ui->screen_MeasurePage_del = true;
    ui->screen_SettingPage_del = true;
    ui->screen_AnalysisPage_del = true;
}
...
void setup_ui(lv_ui *ui)
{
    ...
    init_keyboard(ui);
    setup_scr_screen_MeasurePage(ui);
    setup_scr_screen_SettingPage(ui);
    setup_scr_screen_AnalysisPage(ui);
